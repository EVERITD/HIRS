...
class Mailer
{
	...
	public function get_sender($param1)
	{
		...
		$nm_row2 = mssql_num_rows($rs_sender2);
	...
	{
		$sql_recipient = "
    select email, '2' as sequence from dbo.hris_mainLogIn where temp_pass in (select approver_empno from ref_hris_approver where emp_no = '{$param1}' and approver_empno <> '9900066' and is_approver = 1);
     ";
